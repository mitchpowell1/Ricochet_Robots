 ...
 * A square has row and column data, as well as an initial list of adjacencies and a modified list of
 * adjacencies that is edited when robots are placed/moved on the board.
 * A square also has data regarding whether or not it is occupied, whether or not it is the target
 * square, and whether not it is in the center of the board.
 * @author Mitch Powell
 *
 */
public class Square{
	 ...
	 * @param r the row the square occupies
	 * @param c the column the square occupies
	 * @param adj the list of initial adjacencies for the square
	 * @param occupied the current status of robot occupation of the square
	 * @param targ the current status of the square as the target square for the objective robot
	 * @param cent the status of the square as a center piece on the board.
	 */
	 ...
	 * @return The row the square resides in (0 is the topmost row, 15 is the bottom-most row for a 16x16 board)
	 */
	public int getRow(){
		return row;
	}
	 ...
	 * @param r the row value for the square
	 */
	 ...
	 * @return the column that the square resides in (0 is the leftmost column, 15 is the rightmost column for a 16x16 board)
	 */
	public int getCol(){
		return col;
	}
	 ...
	 * @param c the column number for the square to occupy
	 */
	 ...
	 * @param adj the list of adjacencies for the square.
	 */
	 ...
	 * @param adjNum the number of the item in the list
	 * @param newAdj the new adjacency value to occupy the given index of the modified adjacency list
	 */
	 ...
	 * @param adj the list of modified adjacencies for the square
	 */
	 ...
	 * @param o the new occupation of the square
	 */
	 ...
	 * @param t the new target status of the square
	 */
	 ...
	 * @param c true if the square is a center piece, false otherwise
	 */
